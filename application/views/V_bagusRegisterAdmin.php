                        ...
                        <div class="col-lg-9">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header">
                                    <h3 class="text-center font-weight-light my-4">Create Accounts</h3>
                                </div>
                                <div class="card-body">

                                    <form method="post" action="<?= base_url('C_bagusAuth/registerAdmin'); ?>">
                                        ...
                                        <div class="mt-4 mb-0">
                                            <button type="submit" class="btn btn-primary btn-block mb-1">Register
                                                Account</button>
                                            <div class="small"><a href="<?= base_url('C_bagusAuth/loginAdmin') ?>">sudah
                                                    punya
                                                    akun</a>
                                            </div>
                                        </div>
